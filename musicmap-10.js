...
color adjustColorWithAmplitude(float amplitude) {
  ...
  float saturation = map(amplitude*2000, 0, 1, 1000, 255); // Adjust saturation for varying colors
  float brightness = map(amplitude*200, 1, 1, 1, 1); // Adjust brightness for varying colors
